...
export class ApplicationsList extends React.Component<StateProps, State> {
  ...
  render() {
    ...
    return (
      <div className="toolbar__applications" data-test="applications">
        ...
        {single.map(id => (
          <Applcation id={id} key={id} width={width} data-test="application" />
        ))}
      </div>
    );
  }
