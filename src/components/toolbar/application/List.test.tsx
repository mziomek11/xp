...
import { ApplicationsList as List } from "./List";
...
describe("ToolbarApplicationList Component", () => {
  describe("render", () => {
    ...
    it("should render Application", () => {
      expect(findByTestAtrr(wrapper, "application").length).toBeGreaterThan(0);
    });

    it("should render SelectApplication", () => {
      expect(
        findByTestAtrr(wrapper, "select-application").length
      ).toBeGreaterThan(0);
    });
  });
